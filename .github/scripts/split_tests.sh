...
if [[ "$TEST_TYPE" == "aiter" ]]; then
    ...
    FILE_TIMES[op_tests/test_fused_qk_norm_mrope_cache_quant.py]=960
    FILE_TIMES[op_tests/test_fused_qk_norm_rope_cache_quant.py]=852
    FILE_TIMES[op_tests/test_mla.py]=844
    FILE_TIMES[op_tests/test_mla_persistent.py]=773
    FILE_TIMES[op_tests/test_pa.py]=682
    FILE_TIMES[op_tests/test_batch_prefill.py]=650
    FILE_TIMES[op_tests/test_mha.py]=620
    FILE_TIMES[op_tests/test_moe_2stage.py]=580
    FILE_TIMES[op_tests/test_mla_sparse.py]=571
    FILE_TIMES[op_tests/test_mha_varlen.py]=518
    FILE_TIMES[op_tests/test_rope.py]=404
    FILE_TIMES[op_tests/test_topk_plain.py]=400
    FILE_TIMES[op_tests/test_topk_per_row.py]=268
    FILE_TIMES[op_tests/test_concat_cache_mla.py]=240
    FILE_TIMES[op_tests/test_gemm_a8w8.py]=208
    FILE_TIMES[op_tests/test_gated_delta_rule.py]=190
    FILE_TIMES[op_tests/test_moe_topk_gating.py]=186
    FILE_TIMES[op_tests/test_moe_sorting.py]=146
    FILE_TIMES[op_tests/test_moe_dp_share_expert.py]=119
    FILE_TIMES[op_tests/test_pa_mtp.py]=109
    ...
    FILE_TIMES[op_tests/test_quant.py]=53
    FILE_TIMES[op_tests/test_mhc.py]=50
    FILE_TIMES[op_tests/test_gemm_a8w8_blockscale.py]=43
    ...
    FILE_TIMES[op_tests/test_rmsnorm2d.py]=23
    ...
    FILE_TIMES[op_tests/test_gemm_a16w16.py]=12
    ...
    FILE_TIMES[op_tests/test_gemm_a8w8_blockscale_cktile_aq_rowmajor.py]=5
    ...
    FILE_TIMES[op_tests/triton_tests/test_pa_decode_gluon.py]=764
    FILE_TIMES[op_tests/triton_tests/test_causal_conv1d.py]=744
    FILE_TIMES[op_tests/triton_tests/attention/test_mha_v3.py]=718
    FILE_TIMES[op_tests/triton_tests/attention/test_mha_fp8.py]=680
    ...
    FILE_TIMES[op_tests/triton_tests/rope/test_fused_qkv_split_qk_rope.py]=264
    FILE_TIMES[op_tests/triton_tests/attention/test_mha_with_pe.py]=243
    FILE_TIMES[op_tests/triton_tests/attention/test_mha.py]=189
    FILE_TIMES[op_tests/triton_tests/moe/test_moe.py]=180
    FILE_TIMES[op_tests/triton_tests/attention/test_fav3_sage.py]=169
    FILE_TIMES[op_tests/triton_tests/rope/test_rope.py]=165
    FILE_TIMES[op_tests/triton_tests/fusions/test_mhc.py]=160
    FILE_TIMES[op_tests/triton_tests/moe/test_moe_gemm_a8w8.py]=135
    FILE_TIMES[op_tests/triton_tests/moe/test_moe_gemm_a8w8_blockscale.py]=128
    FILE_TIMES[op_tests/triton_tests/gemm/batched/test_batched_gemm_afp4wfp4.py]=124
    FILE_TIMES[op_tests/triton_tests/attention/test_mla.py]=121
    FILE_TIMES[op_tests/triton_tests/quant/test_fused_mxfp4_quant.py]=119
    FILE_TIMES[op_tests/triton_tests/gemm/fused/test_fused_gemm_afp4wfp4_mul_add.py]=114
    ...
    FILE_TIMES[op_tests/triton_tests/moe/test_moe_gemm_a8w4.py]=105
    FILE_TIMES[op_tests/triton_tests/attention/test_mha_with_sink.py]=102
    FILE_TIMES[op_tests/triton_tests/moe/test_moe_routing.py]=100
    FILE_TIMES[op_tests/triton_tests/attention/test_unified_attention.py]=96
    FILE_TIMES[op_tests/triton_tests/moe/test_moe_gemm_a4w4.py]=95
    FILE_TIMES[op_tests/triton_tests/gemm/feed_forward/test_ff_a16w16_fused.py]=92
    FILE_TIMES[op_tests/triton_tests/normalization/test_layernorm.py]=84
    ...
    FILE_TIMES[op_tests/triton_tests/fusions/test_fused_kv_cache.py]=71
    FILE_TIMES[op_tests/triton_tests/attention/test_la.py]=59
    ...
    FILE_TIMES[op_tests/triton_tests/test_activation.py]=50
    ...
    FILE_TIMES[op_tests/triton_tests/gemm/basic/test_gemm_a16w8_blockscale.py]=23
    ...
    FILE_TIMES[op_tests/triton_tests/attention/test_unified_attention_sparse_mla.py]=18
    ...
    FILE_TIMES[op_tests/triton_tests/attention/test_mha_dao_ai.py]=15
    FILE_TIMES[op_tests/triton_tests/attention/test_pa_decode.py]=15
    FILE_TIMES[op_tests/triton_tests/gemm/basic/test_gemm_a16w16.py]=15
    FILE_TIMES[op_tests/triton_tests/gemm/basic/test_gemm_a8w8.py]=15
    FILE_TIMES[op_tests/triton_tests/gemm/basic/test_gemm_a8w8_per_token_scale.py]=15
    FILE_TIMES[op_tests/triton_tests/gemm/basic/test_gemm_a8wfp4.py]=15
    FILE_TIMES[op_tests/triton_tests/gemm/basic/test_gemm_afp4wfp4.py]=15
    FILE_TIMES[op_tests/triton_tests/gemm/feed_forward/test_ff_a16w16.py]=15
    FILE_TIMES[op_tests/triton_tests/gemm/fused/test_fused_gemm_a8w8_blockscale_a16w16.py]=15
    FILE_TIMES[op_tests/triton_tests/gemm/fused/test_fused_gemm_afp4wfp4_a16w16.py]=15
    FILE_TIMES[op_tests/triton_tests/test_gather_kv_b_proj.py]=15
    FILE_TIMES[op_tests/triton_tests/torch_compile/test_compile_gemm_a16w16.py]=15
    FILE_TIMES[op_tests/triton_tests/torch_compile/test_compile_quant_per_tensor.py]=15
    FILE_TIMES[op_tests/triton_tests/torch_compile/test_compile_rope.py]=15
    FILE_TIMES[op_tests/triton_tests/torch_compile/test_compile_topk.py]=15
    ...
    FILE_TIMES[op_tests/triton_tests/fusions/test_fused_clamp_act_mul.py]=9
    ...
    FILE_TIMES[op_tests/triton_tests/test_causal_conv1d_update_single_token.py]=7
    FILE_TIMES[op_tests/triton_tests/fusions/test_fused_qk_concat.py]=6
    ...
    FILE_TIMES[op_tests/triton_tests/moe/test_moe_routing_sigmoid_top1_fused.py]=4
